...
public class MiningWorldOptions implements WorldOptions {
    ...
    public MiningWorldOptions(String worldName) {
        this.worldName = worldName;
        this.seed = NaurelliaWorlds.getInstance().getConfig().getInt("worlds.world_creation.mining.seed");
        this.worldType = WorldType.valueOf(NaurelliaWorlds.getInstance().getConfig().getString("worlds.world_creation.mining.generator"));
        this.customWorldType = CustomWorldType.MINING;
        this.environment = World.Environment.valueOf(NaurelliaWorlds.getInstance().getConfig().getString("worlds.world_creation.mining.environment"));
        this.worldSize = NaurelliaWorlds.getInstance().getConfig().getInt("worlds.world_creation.mining.size");
