...
public class TemporaryWorldOptions implements WorldOptions {
    ...
    public TemporaryWorldOptions(String worldName) {
        this.worldName = worldName;
        this.seed = NaurelliaWorlds.getInstance().getConfig().getInt("worlds.world_creation.temporary.seed");
        this.worldType = WorldType.valueOf(NaurelliaWorlds.getInstance().getConfig().getString("worlds.world_creation.temporary.generator"));
        this.customWorldType = CustomWorldType.TEMPORARY;
        this.environment = World.Environment.valueOf(NaurelliaWorlds.getInstance().getConfig().getString("worlds.world_creation.temporary.environment"));
        this.worldSize = NaurelliaWorlds.getInstance().getConfig().getInt("worlds.world_creation.temporary.size");
